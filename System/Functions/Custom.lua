...
function br.castGroundAtUnit(spellID, radius, minUnits, maxRange, minRange, spellType, unit)
    ...
    if spellType == "heal" then allUnitsInRange = br.getAllies("player", 40) else allUnitsInRange = br.getEnemies(
        "player", maxRange, true) end
...
function br.castGroundAtBestLocation(spellID, radius, minUnits, maxRange, minRange, spellType, castTime)
    ...
    if minRange == nil then minRange = 0 end
    local allUnitsInRange = {}
    if spellType == "heal" then allUnitsInRange = br.getAllies("player", maxRange) else allUnitsInRange = br.getEnemies(
        "player", maxRange, false) end
